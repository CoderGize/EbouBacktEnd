            ...
            <form action="{{ url('/admin/add_testimonial') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="text" name="text_en" class="form-control" cols="5" rows="4" required></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="text" name="text_fr" class="form-control" cols="5" rows="4" required></textarea>
                    </div>
