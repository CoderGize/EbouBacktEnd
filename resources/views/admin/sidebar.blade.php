        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link rounded-3 {{ 'admin/show_brandee' == request()->path() ? 'main-color' : '' }}"
                    ...
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="bi bi-boxes text-danger text-sm opacity-10"></i>
            ...
            <li class="nav-item">
                <a class="nav-link rounded-3 {{ 'admin/show_blog' == request()->path() ? 'main-color' : '' }}"
                    ...
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="bi bi-body-text text-warning text-sm opacity-10"></i>
            ...
            <li class="nav-item">
                <a class="nav-link rounded-3 {{ 'admin/show_faq' == request()->path() ? 'main-color' : '' }}"
                    href="{{ url('/admin/show_faq') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link rounded-3 {{ 'admin/show_subscriber' == request()->path() ? 'main-color' : '' }}"
                    ...
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        {{-- <i class="bi bi-collection text-danger text-sm opacity-10"></i> --}}
                        <i class="bi bi-person-fill-add text-danger text-sm opacity-10"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link rounded-3 {{ 'admin/show_counter' == request()->path() ? 'main-color' : '' }}"
                    ...
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        {{-- <i class="bi bi-collection text-danger text-sm opacity-10"></i> --}}
                        <i class="bi bi-123 text-primary text-sm opacity-10"></i>
                    </div>
